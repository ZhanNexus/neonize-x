...
class MessageApplication(google.protobuf.message.Message):
    ...
    class Metadata(google.protobuf.message.Message):
        ...
        class QuotedMessage(google.protobuf.message.Message):
            ...
            _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["participant", b"participant", "payload", b"payload", "remoteJID", b"remoteJID", "stanzaID", b"stanzaID"]
            def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
            _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["participant", b"participant", "payload", b"payload", "remoteJID", b"remoteJID", "stanzaID", b"stanzaID"]
        ...
        class EphemeralSettingMap(google.protobuf.message.Message):
            ...
            _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["chatJID", b"chatJID", "ephemeralSetting", b"ephemeralSetting"]
            def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
            _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["chatJID", b"chatJID", "ephemeralSetting", b"ephemeralSetting"]
            def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
        ...
        _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["botResponseID", b"botResponseID", "businessMetadata", b"businessMetadata", "chatEphemeralSetting", b"chatEphemeralSetting", "collapsibleID", b"collapsibleID", "ephemeral", b"ephemeral", "ephemeralSettingList", b"ephemeralSettingList", "ephemeralSharedSecret", b"ephemeralSharedSecret", "forwardingScore", b"forwardingScore", "frankingKey", b"frankingKey", "frankingVersion", b"frankingVersion", "groupID", b"groupID", "groupIndex", b"groupIndex", "groupSize", b"groupSize", "isForwarded", b"isForwarded", "quotedMessage", b"quotedMessage", "readonlyMetadataDataclass", b"readonlyMetadataDataclass", "secondaryOtid", b"secondaryOtid", "threadType", b"threadType"]
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["botResponseID", b"botResponseID", "businessMetadata", b"businessMetadata", "chatEphemeralSetting", b"chatEphemeralSetting", "collapsibleID", b"collapsibleID", "ephemeral", b"ephemeral", "ephemeralSettingList", b"ephemeralSettingList", "ephemeralSharedSecret", b"ephemeralSharedSecret", "forwardingScore", b"forwardingScore", "frankingKey", b"frankingKey", "frankingVersion", b"frankingVersion", "groupID", b"groupID", "groupIndex", b"groupIndex", "groupSize", b"groupSize", "isForwarded", b"isForwarded", "quotedMessage", b"quotedMessage", "readonlyMetadataDataclass", b"readonlyMetadataDataclass", "secondaryOtid", b"secondaryOtid", "threadType", b"threadType"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
        _WhichOneofReturnType_ephemeral: typing_extensions.TypeAlias = typing.Literal["chatEphemeralSetting", "ephemeralSettingList", "ephemeralSharedSecret"]
        _WhichOneofArgType_ephemeral: typing_extensions.TypeAlias = typing.Literal["ephemeral", b"ephemeral"]
    ...
    class Payload(google.protobuf.message.Message):
        ...
        _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["applicationData", b"applicationData", "content", b"content", "coreContent", b"coreContent", "signal", b"signal", "subProtocol", b"subProtocol"]
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["applicationData", b"applicationData", "content", b"content", "coreContent", b"coreContent", "signal", b"signal", "subProtocol", b"subProtocol"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
        _WhichOneofReturnType_content: typing_extensions.TypeAlias = typing.Literal["coreContent", "signal", "applicationData", "subProtocol"]
    ...
    class SubProtocolPayload(google.protobuf.message.Message):
        ...
        _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["armadillo", b"armadillo", "businessMessage", b"businessMessage", "consumerMessage", b"consumerMessage", "futureProof", b"futureProof", "multiDevice", b"multiDevice", "paymentMessage", b"paymentMessage", "subProtocol", b"subProtocol", "voip", b"voip"]
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["armadillo", b"armadillo", "businessMessage", b"businessMessage", "consumerMessage", b"consumerMessage", "futureProof", b"futureProof", "multiDevice", b"multiDevice", "paymentMessage", b"paymentMessage", "subProtocol", b"subProtocol", "voip", b"voip"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
        _WhichOneofReturnType_subProtocol: typing_extensions.TypeAlias = typing.Literal["consumerMessage", "businessMessage", "paymentMessage", "multiDevice", "voip", "armadillo"]
        _WhichOneofArgType_subProtocol: typing_extensions.TypeAlias = typing.Literal["subProtocol", b"subProtocol"]
    ...
    class EphemeralSetting(google.protobuf.message.Message):
        ...
        _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["ephemeralExpiration", b"ephemeralExpiration", "ephemeralSettingTimestamp", b"ephemeralSettingTimestamp", "ephemeralityType", b"ephemeralityType", "isEphemeralSettingReset", b"isEphemeralSettingReset"]
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["ephemeralExpiration", b"ephemeralExpiration", "ephemeralSettingTimestamp", b"ephemeralSettingTimestamp", "ephemeralityType", b"ephemeralityType", "isEphemeralSettingReset", b"isEphemeralSettingReset"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
