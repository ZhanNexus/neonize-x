...
class DeviceCapabilities(google.protobuf.message.Message):
    ...
    class AiThread(google.protobuf.message.Message):
        ...
        _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["supportLevel", b"supportLevel"]
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["supportLevel", b"supportLevel"]
    ...
    class UserHasAvatar(google.protobuf.message.Message):
        ...
        _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["userHasAvatar", b"userHasAvatar"]
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["userHasAvatar", b"userHasAvatar"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    class BusinessBroadcast(google.protobuf.message.Message):
        ...
        _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["importListEnabled", b"importListEnabled"]
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["importListEnabled", b"importListEnabled"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    class LIDMigration(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["chatDbMigrationTimestamp", b"chatDbMigrationTimestamp"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["aiThread", b"aiThread", "businessBroadcast", b"businessBroadcast", "chatLockSupportLevel", b"chatLockSupportLevel", "lidMigration", b"lidMigration", "memberNameTagPrimarySupport", b"memberNameTagPrimarySupport", "userHasAvatar", b"userHasAvatar"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["aiThread", b"aiThread", "businessBroadcast", b"businessBroadcast", "chatLockSupportLevel", b"chatLockSupportLevel", "lidMigration", b"lidMigration", "memberNameTagPrimarySupport", b"memberNameTagPrimarySupport", "userHasAvatar", b"userHasAvatar"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
