...
class GroupHistory(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["associatedMessageLists", b"associatedMessageLists", "commentMessages", b"commentMessages", "messages", b"messages"]
...
class AssociatedMessageList(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["associationType", b"associationType", "parentMessage", b"parentMessage"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["associationType", b"associationType", "messages", b"messages", "parentMessage", b"parentMessage"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
