...
class SupplementMessagePayload(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["content", b"content", "targetMessageOtid", b"targetMessageOtid", "targetMessageWaServerTimeSec", b"targetMessageWaServerTimeSec", "targetWaThreadID", b"targetWaThreadID", "uniquingKeyForSupplementalData", b"uniquingKeyForSupplementalData"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["content", b"content", "targetMessageOtid", b"targetMessageOtid", "targetMessageWaServerTimeSec", b"targetMessageWaServerTimeSec", "targetWaThreadID", b"targetWaThreadID", "uniquingKeyForSupplementalData", b"uniquingKeyForSupplementalData"]
...
class SupplementMessageContent(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["contentView", b"contentView", "editText", b"editText", "mediaInterventions", b"mediaInterventions", "mediaReaction", b"mediaReaction", "originalTransportPayload", b"originalTransportPayload", "reaction", b"reaction", "supplementMessageContent", b"supplementMessageContent"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["contentView", b"contentView", "editText", b"editText", "mediaInterventions", b"mediaInterventions", "mediaReaction", b"mediaReaction", "originalTransportPayload", b"originalTransportPayload", "reaction", b"reaction", "supplementMessageContent", b"supplementMessageContent"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType_supplementMessageContent: typing_extensions.TypeAlias = typing.Literal["reaction", "contentView", "editText", "mediaReaction", "originalTransportPayload", "mediaInterventions"]
    _WhichOneofArgType_supplementMessageContent: typing_extensions.TypeAlias = typing.Literal["supplementMessageContent", b"supplementMessageContent"]
...
class MediaReaction(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["mediaID", b"mediaID", "reaction", b"reaction"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["mediaID", b"mediaID", "reaction", b"reaction"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class Reaction(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["actionLogOtid", b"actionLogOtid", "emoji", b"emoji", "reactionStatus", b"reactionStatus", "reactionType", b"reactionType", "superReactType", b"superReactType"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["actionLogOtid", b"actionLogOtid", "emoji", b"emoji", "reactionStatus", b"reactionStatus", "reactionType", b"reactionType", "superReactType", b"superReactType"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class ContentView(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["mimetype", b"mimetype", "objectID", b"objectID", "replayed", b"replayed", "screenshotted", b"screenshotted", "seen", b"seen"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["mimetype", b"mimetype", "objectID", b"objectID", "replayed", b"replayed", "screenshotted", b"screenshotted", "seen", b"seen"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class EditText(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["editCount", b"editCount", "newContent", b"newContent"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["editCount", b"editCount", "newContent", b"newContent"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class OriginalTransportPayload(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["originalTransportPayload", b"originalTransportPayload"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["originalTransportPayload", b"originalTransportPayload"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class MediaInterventions(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["interventionType", b"interventionType", "mediaID", b"mediaID"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["interventionType", b"interventionType", "mediaID", b"mediaID"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
