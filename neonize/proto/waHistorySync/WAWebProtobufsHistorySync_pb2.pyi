...
Global___MediaVisibility: typing_extensions.TypeAlias = MediaVisibility
...
Global___PrivacySystemMessage: typing_extensions.TypeAlias = PrivacySystemMessage
...
class HistorySync(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["aiWaitListState", b"aiWaitListState", "chunkOrder", b"chunkOrder", "companionMetaNonce", b"companionMetaNonce", "globalSettings", b"globalSettings", "progress", b"progress", "shareableChatIdentifierEncryptionKey", b"shareableChatIdentifierEncryptionKey", "syncType", b"syncType", "threadDsTimeframeOffset", b"threadDsTimeframeOffset", "threadIDUserSecret", b"threadIDUserSecret"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["accounts", b"accounts", "aiWaitListState", b"aiWaitListState", "callLogRecords", b"callLogRecords", "chunkOrder", b"chunkOrder", "companionMetaNonce", b"companionMetaNonce", "conversations", b"conversations", "globalSettings", b"globalSettings", "pastParticipants", b"pastParticipants", "phoneNumberToLidMappings", b"phoneNumberToLidMappings", "progress", b"progress", "pushnames", b"pushnames", "recentStickers", b"recentStickers", "shareableChatIdentifierEncryptionKey", b"shareableChatIdentifierEncryptionKey", "statusV3Messages", b"statusV3Messages", "syncType", b"syncType", "threadDsTimeframeOffset", b"threadDsTimeframeOffset", "threadIDUserSecret", b"threadIDUserSecret"]
...
class Conversation(google.protobuf.message.Message):
    ...
    LIMITSHARINGTRIGGER_FIELD_NUMBER: builtins.int
    LIMITSHARINGINITIATEDBYME_FIELD_NUMBER: builtins.int
    MAIBAAITHREADENABLED_FIELD_NUMBER: builtins.int
    ID: builtins.str
    newJID: builtins.str
    oldJID: builtins.str
    ...
    limitSharing: builtins.bool
    limitSharingSettingTimestamp: builtins.int
    limitSharingTrigger: waCommon.WACommon_pb2.LimitSharing.Trigger.ValueType
    limitSharingInitiatedByMe: builtins.bool
    maibaAiThreadEnabled: builtins.bool
    @property
...
class GroupParticipant(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["memberLabel", b"memberLabel", "rank", b"rank", "userJID", b"userJID"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["memberLabel", b"memberLabel", "rank", b"rank", "userJID", b"userJID"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class PastParticipant(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["leaveReason", b"leaveReason", "leaveTS", b"leaveTS", "userJID", b"userJID"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["leaveReason", b"leaveReason", "leaveTS", b"leaveTS", "userJID", b"userJID"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___PastParticipant: typing_extensions.TypeAlias = PastParticipant
...
Global___PhoneNumberToLIDMapping: typing_extensions.TypeAlias = PhoneNumberToLIDMapping
...
class Account(google.protobuf.message.Message):
    ...
    ISUSERNAMEDELETED_FIELD_NUMBER: builtins.int
    lid: builtins.str
    username: builtins.str
    countryCode: builtins.str
    isUsernameDeleted: builtins.bool
    def __init__(
        self,
        *,
        lid: builtins.str | None = ...,
        username: builtins.str | None = ...,
        countryCode: builtins.str | None = ...,
        isUsernameDeleted: builtins.bool | None = ...,
    ) -> None: ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["countryCode", b"countryCode", "isUsernameDeleted", b"isUsernameDeleted", "lid", b"lid", "username", b"username"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["countryCode", b"countryCode", "isUsernameDeleted", b"isUsernameDeleted", "lid", b"lid", "username", b"username"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class HistorySyncMsg(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["message", b"message", "msgOrderID", b"msgOrderID"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["message", b"message", "msgOrderID", b"msgOrderID"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___HistorySyncMsg: typing_extensions.TypeAlias = HistorySyncMsg
...
class Pushname(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["ID", b"ID", "pushname", b"pushname"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["ID", b"ID", "pushname", b"pushname"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___Pushname: typing_extensions.TypeAlias = Pushname
...
class WallpaperSettings(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["filename", b"filename", "opacity", b"opacity"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["filename", b"filename", "opacity", b"opacity"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___WallpaperSettings: typing_extensions.TypeAlias = WallpaperSettings
...
class AutoDownloadSettings(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["downloadAudio", b"downloadAudio", "downloadDocuments", b"downloadDocuments", "downloadImages", b"downloadImages", "downloadVideo", b"downloadVideo"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["downloadAudio", b"downloadAudio", "downloadDocuments", b"downloadDocuments", "downloadImages", b"downloadImages", "downloadVideo", b"downloadVideo"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___AutoDownloadSettings: typing_extensions.TypeAlias = AutoDownloadSettings
...
class StickerMetadata(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["URL", b"URL", "directPath", b"directPath", "fileEncSHA256", b"fileEncSHA256", "fileLength", b"fileLength", "fileSHA256", b"fileSHA256", "height", b"height", "imageHash", b"imageHash", "isAvatarSticker", b"isAvatarSticker", "isLottie", b"isLottie", "lastStickerSentTS", b"lastStickerSentTS", "mediaKey", b"mediaKey", "mimetype", b"mimetype", "weight", b"weight", "width", b"width"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["URL", b"URL", "directPath", b"directPath", "fileEncSHA256", b"fileEncSHA256", "fileLength", b"fileLength", "fileSHA256", b"fileSHA256", "height", b"height", "imageHash", b"imageHash", "isAvatarSticker", b"isAvatarSticker", "isLottie", b"isLottie", "lastStickerSentTS", b"lastStickerSentTS", "mediaKey", b"mediaKey", "mimetype", b"mimetype", "weight", b"weight", "width", b"width"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___StickerMetadata: typing_extensions.TypeAlias = StickerMetadata
...
class PastParticipants(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["groupJID", b"groupJID"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["groupJID", b"groupJID", "pastParticipants", b"pastParticipants"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___PastParticipants: typing_extensions.TypeAlias = PastParticipants
...
class AvatarUserSettings(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["FBID", b"FBID", "password", b"password"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["FBID", b"FBID", "password", b"password"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___AvatarUserSettings: typing_extensions.TypeAlias = AvatarUserSettings
...
class NotificationSettings(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["callVibrate", b"callVibrate", "lowPriorityNotifications", b"lowPriorityNotifications", "messageLight", b"messageLight", "messagePopup", b"messagePopup", "messageVibrate", b"messageVibrate", "reactionsMuted", b"reactionsMuted"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["callVibrate", b"callVibrate", "lowPriorityNotifications", b"lowPriorityNotifications", "messageLight", b"messageLight", "messagePopup", b"messagePopup", "messageVibrate", b"messageVibrate", "reactionsMuted", b"reactionsMuted"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___NotificationSettings: typing_extensions.TypeAlias = NotificationSettings
