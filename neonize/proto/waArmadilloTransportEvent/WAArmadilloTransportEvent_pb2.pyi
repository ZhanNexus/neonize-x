...
class TransportEvent(google.protobuf.message.Message):
    ...
    class Event(google.protobuf.message.Message):
        ...
        class DeviceChange(google.protobuf.message.Message):
            ...
            _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["deviceModel", b"deviceModel", "deviceName", b"deviceName", "devicePlatform", b"devicePlatform", "type", b"type"]
            def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
            _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["deviceModel", b"deviceModel", "deviceName", b"deviceName", "devicePlatform", b"devicePlatform", "type", b"type"]
            def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
        ...
        _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["deviceChange", b"deviceChange", "event", b"event", "icdcAlert", b"icdcAlert"]
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["deviceChange", b"deviceChange", "event", b"event", "icdcAlert", b"icdcAlert"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
        _WhichOneofReturnType_event: typing_extensions.TypeAlias = typing.Literal["deviceChange", "icdcAlert"]
        _WhichOneofArgType_event: typing_extensions.TypeAlias = typing.Literal["event", b"event"]
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["content", b"content", "event", b"event", "placeholder", b"placeholder"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["content", b"content", "event", b"event", "placeholder", b"placeholder"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType_content: typing_extensions.TypeAlias = typing.Literal["placeholder", "event"]
