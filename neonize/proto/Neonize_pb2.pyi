...
class SendRequestExtra(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["ID", b"ID", "InlineBotJID", b"InlineBotJID", "MediaHandle", b"MediaHandle", "Peer", b"Peer", "Timeout", b"Timeout"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
