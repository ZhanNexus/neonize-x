...
class Link(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["linkContext", b"linkContext", "text", b"text"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["linkContext", b"linkContext", "text", b"text"]
...
class LinkContext(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["linkImageURL", b"linkImageURL", "linkMusicPreviewURL", b"linkMusicPreviewURL", "linkPreviewBody", b"linkPreviewBody", "linkPreviewThumbnail", b"linkPreviewThumbnail", "linkPreviewTitle", b"linkPreviewTitle", "linkSummary", b"linkSummary", "linkURL", b"linkURL"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["linkImageURL", b"linkImageURL", "linkMusicPreviewCountriesAllowed", b"linkMusicPreviewCountriesAllowed", "linkMusicPreviewURL", b"linkMusicPreviewURL", "linkPreviewBody", b"linkPreviewBody", "linkPreviewThumbnail", b"linkPreviewThumbnail", "linkPreviewTitle", b"linkPreviewTitle", "linkSummary", b"linkSummary", "linkURL", b"linkURL"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class ImageUrl(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["URL", b"URL", "height", b"height", "width", b"width"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["URL", b"URL", "height", b"height", "width", b"width"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
