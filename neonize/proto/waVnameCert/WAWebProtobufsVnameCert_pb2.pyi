...
class BizAccountLinkInfo(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["accountType", b"accountType", "hostStorage", b"hostStorage", "issueTime", b"issueTime", "whatsappAcctNumber", b"whatsappAcctNumber", "whatsappBizAcctFbid", b"whatsappBizAcctFbid"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["accountType", b"accountType", "hostStorage", b"hostStorage", "issueTime", b"issueTime", "whatsappAcctNumber", b"whatsappAcctNumber", "whatsappBizAcctFbid", b"whatsappBizAcctFbid"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___BizAccountLinkInfo: typing_extensions.TypeAlias = BizAccountLinkInfo
...
class BizIdentityInfo(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["actualActors", b"actualActors", "featureControls", b"featureControls", "hostStorage", b"hostStorage", "privacyModeTS", b"privacyModeTS", "revoked", b"revoked", "signed", b"signed", "vlevel", b"vlevel", "vnameCert", b"vnameCert"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["actualActors", b"actualActors", "featureControls", b"featureControls", "hostStorage", b"hostStorage", "privacyModeTS", b"privacyModeTS", "revoked", b"revoked", "signed", b"signed", "vlevel", b"vlevel", "vnameCert", b"vnameCert"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___BizIdentityInfo: typing_extensions.TypeAlias = BizIdentityInfo
...
class LocalizedName(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["lc", b"lc", "lg", b"lg", "verifiedName", b"verifiedName"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["lc", b"lc", "lg", b"lg", "verifiedName", b"verifiedName"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___LocalizedName: typing_extensions.TypeAlias = LocalizedName
...
class VerifiedNameCertificate(google.protobuf.message.Message):
    ...
    class Details(google.protobuf.message.Message):
        ...
        _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["issueTime", b"issueTime", "issuer", b"issuer", "serial", b"serial", "verifiedName", b"verifiedName"]
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["issueTime", b"issueTime", "issuer", b"issuer", "localizedNames", b"localizedNames", "serial", b"serial", "verifiedName", b"verifiedName"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["details", b"details", "serverSignature", b"serverSignature", "signature", b"signature"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["details", b"details", "serverSignature", b"serverSignature", "signature", b"signature"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___VerifiedNameCertificate: typing_extensions.TypeAlias = VerifiedNameCertificate
...
class BizAccountPayload(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["bizAcctLinkInfo", b"bizAcctLinkInfo", "vnameCert", b"vnameCert"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["bizAcctLinkInfo", b"bizAcctLinkInfo", "vnameCert", b"vnameCert"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___BizAccountPayload: typing_extensions.TypeAlias = BizAccountPayload
